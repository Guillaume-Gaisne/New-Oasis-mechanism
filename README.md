![docker image](https://github.com/Guillaume-Gaisne/New-Oasis-mechanism/actions/workflows/docker-publish.yml/badge.svg)
...
2. Clone the repository or download the repository as a zip file.
    ...
    ```sh
    git clone https://github.com/Guillaume-Gaisne/New-Oasis-mechanism.git
    cd New-Oasis-mechanism
    ```

    or

    ```sh
    curl-L -o New-Oasis-mechanism.zip "https://github.com/Guillaume-Gaisne/New-Oasis-mechanism/archive/main.zip"
    unzip New-Oasis-mechanism.zip
    cd New-Oasis-mechanism
    ```
...
your `docker-compose.yaml` with `ghcr.io/guillaume-gaisne/new-oasis-mechanism:main` for the services
...
```
docker pull ghcr.io/guillaume-gaisne/new-oasis-mechanism/jupyter:main
```
...
_I get an_ `Error response from daemon: Head "https://ghcr.io/v2/Guillaume-Gaisne/New-Oasis-mechanism/manifests/main": unauthorized`
